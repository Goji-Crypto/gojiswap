...
const {
  ...
  networkIdMainNet,
  providerUrl,
  quickswapConConfig: { add: UniSwapConAdd },
  quickswapConConfig: { abi: UniSwapConAbi },
...
function Home(props) {
  ...
  return (
    <div className="quickswap">
      <img
        alt=""
        className="position-absolute gradient sushiswap"
        src="img/quickSwap-gradient.svg"
      />
      <img
        alt=""
        className="position-absolute watermark sushiswap"
        src="img/quickSwap-watermark.svg"
      />

      <TopNav selectedTab={"quickswap"} />
